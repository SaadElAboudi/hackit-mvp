...
class AnalyticsManager {
  ...
  bool _enabled = true; // disable gracefully if init fails or unsupported
  ...
  Future<void> _ensureInitialized() async {
    ...
    try {
      // On web, this requires Firebase config. If missing, we'll no-op.
      await Firebase.initializeApp();
      _analytics = FirebaseAnalytics.instance;
      _initialized = true;
    } catch (e) {
      // Disable analytics to avoid crashing app in dev environments
      _enabled = false;
      _initialized = true;
    }
  }
